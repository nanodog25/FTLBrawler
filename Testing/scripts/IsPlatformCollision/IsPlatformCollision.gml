...
switch(dir)
{
	...
	case "left":
			return collision_line(xLeft, yUp + _collisionBuffer, xLeft, yDown - _collisionBuffer, obj, true, true);
	case "right":
		return collision_line(xRight, yUp + _collisionBuffer, xRight, yDown - _collisionBuffer, obj, true, true);
}